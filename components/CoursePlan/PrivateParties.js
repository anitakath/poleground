        ...
        <div>
            <div className="w-full"> 
                <div className="flex my-4">
                    <div className="mr-2 w-8/12 h-60 flex items-center"> 
                        <h1 className=" text-xl text-center w-full"> PRIVATE PARTIES & PERSONAL TRAINING </h1>
                    </div>
                ...
                <div className="flex">
                    <div className={`w-full flex-col overflow-scroll  m-2 ${styles.privateInfo}`}> 
                        ...
                        <button className={styles.button} onClick={() => showInfoHandler('parties')}> MEHR ... </button>
                        {showInfo.parties && (
                    ...
                    <div className={`w-full flex-col h-96 overflow-scroll m-2 ${styles.privateInfo}`}> 
                        ...
                        <button className={styles.button} onClick={() => showInfoHandler('training')}> MEHR ... </button>
                        {showInfo.training && (
                            <p className={styles.infoParagraph}>
